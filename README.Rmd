...
It allows users to retrieve, filter, and harmonize classification data from the [Philippine Statistics Authority](https://psa.gov.ph/classification) (PSA)'s open-access data and other sources, making it easier to work with Philippine statistical data in R.
